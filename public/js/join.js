...
function Validation(){
  ...
  //이메일 유효성검사
  //id와 password에 a-z가 가능하고 0-9고 4자리~12자리까지 사용할 수 있다
  var e_RegExp = /^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i;
  //이메일 유효성 검사라 @와 .이 들어있다
  var n_RegExp = /^[가-힣]{2,15}$/; //이름 유효성검사 정규식
  //위에선 이름은 한글 이름만 가능하다고 하는 것 
...
//   var objAdress = document.getElementById("adress"); //주소/
  ...
  if(!n_RegExp.test(objAdress.value)){
      alert("특수문자,영어,숫자는 사용할수 없습니다. 한글만 입력하여주세요.");
      return false;
  }
